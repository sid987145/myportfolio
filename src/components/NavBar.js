  ...
  return (
    <Router>
      <Navbar expand="md" className={scrolled ? "scrolled" : ""}>
        <Container>
          <Navbar.Brand href="/">
            <img src={logo} alt="Welcome to My World of Code and Innovation" />
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <Nav.Link href="#viewResume" className={activeLink === 'viewResume' ? 'active navbar-link' : 'navbar-link'} onClick={() => onUpdateActiveLink('viewResume')}>Resume</Nav.Link>
            </Nav>
